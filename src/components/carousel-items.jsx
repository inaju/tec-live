const CarouselItems = ({ imageLocation, imageSrc, subText, text, mobileImageSrc }) => {
  return (
    ...
    mb-[180px] flex xl:w-[800px] lg:w-[300px] pb-[100px] lg:pb-[0px] mx-auto  justify-between border-[5px] border-solid
  border-[rgba(255,114,0,0.20)] p-8 xl:py-[9.5625rem] xl:px-[3.75rem] min-h-[44.375rem] lg:mb-[16.375rem]`}>
      <CarouselImage imageLocation={imageLocation} imageSrc={imageSrc} mobileImageSrc={mobileImageSrc} />
...
const getCorrectPosition = (imageLocation) => {
  if (imageLocation == 'right') {
    return `absolute lg:-right-[20rem] lg:top-[3.9375rem] -bottom-[400px]`;
  }
  if (imageLocation == 'left') {
    return `absolute lg:-left-[15rem] lg:top-[3.9375rem] left-[10px] -bottom-[350px]`;
  }
};
