...
const BottomCTA = () => {
  return (
    <div className="relative border-red-500">
      <div
        className="bg-mobile-cta-background-image lg:bg-cta-background-image bg-no-repeat bg-[-20.25rem_-0.4rem] lg:bg-[0rem_-0rem]   bg-[length:180vw_350vh] xl:bg-[length:100vw_150vh] px-10 xl:px-0  absolute right-0 top-0 mx-auto flex  pt-[100px] lg:h-[180vh] w-screen flex-col items-left xl:items-center justify-center"
      >
        ...
        <div className="lg:hidden flex flex-col  gap-10 items-start mx-1 sm:flex-row justify-between max-w-[81rem] lg:mx-auto  mt-10 mb-20 ">
