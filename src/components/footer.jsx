...
const Footer = () => {
    return (
        <div className="bg-[#121519] pb-48">
            <div className="bg-[#65656599] h-0.5  items-center flex mx-auto"></div>
            <div className="flex flex-col  gap-10  sm:flex-row justify-between max-w-[81rem] mx-auto mt-10 mb-20">
...
const FooterItem = ({ text }) => {
    return (
        <p><a className="font-inter leading-8 font-normal inline-flex text-[1.5rem]  gap-x-2 text-gray-600 hover:text-gray-800 dark:text-gray-400 dark:hover:text-gray-200 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600" href="#">{text}</a></p>
    )
}
